...
const timelineData: TimelineItem[] = [
  {
    ...
    period: "2022 – 2026",
    description:
      "Studying at Radhakrishna Institute of Technology and Engineering. Built multiple hands-on projects leveraging modern web technologies including HTML, CSS, Bootstrap, JavaScript, Python, and MySQL.",
  },
  {
    type: "education",
